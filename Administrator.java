	...
	public static void main(String[] args) {
		...
		do {
			...
			case 12: //Schedule an appointment
					...
					searchRID = userInput.next();// user input for recipient in the list
					...
					for (int RID = 0; RID < recipList.size(); RID++) {
						...
						{
							System.out.println("Not a valid recipient... returning to menu");
							break;
						}
			...
			case 13://Reschedule  Appointment
					...
					for (int aptFind = 0; aptFind < appointmentList.size(); aptFind++) {
						...
						else if(aptExists == false) {
							System.out.println("Appointment not found");
							System.out.println("Going back to menu");
							break;
						}
						if(aptChange == true) {
							appointmentList.get(aptFind).setTime(rescheduleTime);
							break;
						}
